...
const itemWarehouseCreateSchema = z.object({
  ...
  data_entrada: z
    .string({
      invalid_type_error:
        'A data de entrada deve ser uma string no formato ISO.',
    })
    .datetime({
      message:
        'A data de entrada deve estar no formato ISO 8601 (YYYY-MM-DDTHH:mm:ss.sssZ).',
    })
    .optional(),
  data_saida: z
    .string({
    ...
    .datetime({
      message:
        'A data de saída deve estar no formato ISO 8601 (YYYY-MM-DDTHH:mm:ss.sssZ).',
    })
    .optional()
    .nullable(),
});

const itemWarehouseUpdateSchema = z
  .object({
    quantidade: z
      .number({
        invalid_type_error: 'A quantidade deve ser um número.',
    ...
    data_saida: z
      .string({
        invalid_type_error:
          'A data de saída deve ser uma string no formato ISO.',
      })
      .datetime({
        message:
          'A data de saída deve estar no formato ISO 8601 (YYYY-MM-DDTHH:mm:ss.sssZ).',
